new_client () {
	...
	echo "   2) Отозвать клиента"
        echo "   3) Подписать CSR и выдать конфиг на 1 день"
        echo "   4) Подписать CSR и выдать конфиг на 5 дней"
        echo "   5) Подписать CSR и выдать конфиг на 10 дней"
        echo "   6) Подписать CSR и выдать конфиг на 30 дней"
        echo "   7) Подписать CSR и выдать конфиг на 50 дней"
        echo "   8) Подписать CSR и выдать конфиг на 60 дней"
	echo "   9) Подписать CSR и выдать конфиг на 90 дней"
        echo "   10) Подписать CSR и выдать конфиг на 180 дней"
        echo "   11) Подписать CSR и выдать конфиг на 365 дней"
        echo "   12) Подписать CSR и выдать конфиг на 3650 дней"
        echo "   13) Перегенерация crl.pem"
        echo "   14) Отправить конфигурацию на ноды"
